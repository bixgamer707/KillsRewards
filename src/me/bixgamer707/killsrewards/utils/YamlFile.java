...
public class YamlFile extends YamlConfiguration {
    ...
    private final KillsRewards plugin;
 
    private File file;
 
    private File folder;
 
    public YamlFile(KillsRewards plugin, String fileName, File folder) {
        this.folder = folder;
        this.plugin = plugin;
    ...
    public YamlFile(me.bixgamer707.killsrewards.KillsRewards plugin, String fileName) {
